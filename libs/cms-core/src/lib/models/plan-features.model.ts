...
export const TIER_FEATURES: Record<PlanTier, TenantFeatures> = {
  starter: {
    platform: { customDomain: false, customCss: false, multipleAuthors: false, analytics: false },
    unlockedPageTypes: ['about', 'links'],
  },
  pro: {
    platform: { customDomain: true, customCss: false, multipleAuthors: false, analytics: true },
    unlockedPageTypes: ['about', 'links', 'videoWalkthrough', 'donate'],
  },
  agency: {
    platform: { customDomain: true, customCss: true, multipleAuthors: true, analytics: true },
