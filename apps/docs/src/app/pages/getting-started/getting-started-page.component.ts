...
@Component({
  ...
  template: `
    ...
    <section class="mt-10">
      ...
      <p class="mt-4">Configure Firebase Hosting in <code>firebase.json</code>:</p>
      <docs-code-block [code]="firebaseJson" language="json" />
    </section>

    <section class="mt-10">
      <h2 id="app-config">App Config</h2>
      <p>Wire up Firebase and <code>SHELL_CONFIG</code> in your <code>app.config.ts</code>:</p>
