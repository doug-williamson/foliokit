...
const tokenRows: ApiTableRow[] = [
  ...
  { name: '--font-sans', type: 'font-family', description: 'Body / UI font stack (RhombusKit contract)', required: false },
  { name: '--font-prose', type: 'font-family', description: 'Long-form prose font stack (RhombusKit contract)', required: false },
  { name: '--font-mono', type: 'font-family', description: 'Monospace font stack (RhombusKit contract)', required: false },
  { name: '--font-display', type: 'font-family', description: 'Heading / display font stack (FolioKit-local extension)', required: false },
  { name: '--radius-sm', type: 'length', description: 'Small radius (2px)', required: false },
  { name: '--radius-xs', type: 'length', description: 'Extra-small radius (4px)', required: false },
  { name: '--radius-md', type: 'length', description: 'Medium radius (6px)', required: false },
  { name: '--radius-lg', type: 'length', description: 'Large radius — cards, buttons (10px)', required: false },
  { name: '--radius-xl', type: 'length', description: 'Extra-large radius (14px)', required: false },
  { name: '--radius-2xl', type: 'length', description: 'FolioKit-local radius extension (20px)', required: false },
  { name: '--radius-full', type: 'length', description: 'Pill / circular radius (9999px)', required: false },
];
