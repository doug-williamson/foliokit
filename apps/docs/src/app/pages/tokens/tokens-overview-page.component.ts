...
@Component({
  ...
  template: `
    ...
    <p class="mb-8 leading-relaxed" style="color: var(--mat-sys-on-surface-variant)">
      ...
      >
        <mat-card class="h-full cursor-pointer hover:shadow-md transition-shadow">
          <mat-card-content class="flex flex-col gap-3 p-5">
            ...
            <h3 class="text-base font-semibold m-0">SHELL_CONFIG</h3>
      ...
      >
        <mat-card class="h-full cursor-pointer hover:shadow-md transition-shadow">
          <mat-card-content class="flex flex-col gap-3 p-5">
            ...
            <h3 class="text-base font-semibold m-0">SeoMeta</h3>
            <p class="text-sm m-0 leading-relaxed" style="color: var(--mat-sys-on-surface-variant)">
      ...
      >
        <mat-card class="h-full cursor-pointer hover:shadow-md transition-shadow">
          <mat-card-content class="flex flex-col gap-3 p-5">
            ...
            <h3 class="text-base font-semibold m-0">EmbeddedMediaEntry</h3>
            <p class="text-sm m-0 leading-relaxed" style="color: var(--mat-sys-on-surface-variant)">
